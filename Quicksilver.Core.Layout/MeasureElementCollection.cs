...
{
    /// <summary>
    /// Manage a collection of MeasureElement derived instances.
    /// </summary>
    public partial class MeasureElementCollection<T> : IList,
                                                       IList<T>,
                                                       ICollection,
                                                       ICollection<T>,
                                                       IEnumerable,
                                                       IEnumerable<T>
                                                       where T : MeasureElement
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the MeasureElementCollection class.
        /// </summary>
        /// <param name="logicalParent">Reference to logical parent of this collection.</param>
        internal MeasureElementCollection(ILogicalParent logicalParent)
        {
        ...
        public int Add(object value)
        {
            if (value is T)
            {
                ...
                throw new ArgumentException("Parameter does not derive from element type.");
        }
