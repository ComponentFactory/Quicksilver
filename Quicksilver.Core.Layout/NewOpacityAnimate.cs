...
namespace ComponentFactory.Quicksilver.Layout
{
    ...
    {
        #region Constants
        private static readonly double DEFAULT_START = 0.0;
        private static readonly double DEFAULT_END = 1.0;
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the NewOpacityAnimate class.
        /// </summary>
        public NewOpacityAnimate()
